...
module.exports = function (configuration) {
    ...
    var tableAccess = function (table) {
        ...
        if (table.dynamicSchema === undefined || table.dynamicSchema)
            return {
                read: function (query) {
                    return dynamicSchema(configuration).read(table, statements.read(query, table)).then(translateVersion);
                },
                ...
                undelete: function (id, version) {
                    return execute(configuration, statements.undelete(table, id, version)).then(returnDeleteResults);
                },
                truncate: function () {
            ...
            return {
                read: function (query) {
                    return execute(configuration, statements.read(query, table)).then(translateVersion);
                },
                update: function (item) {
