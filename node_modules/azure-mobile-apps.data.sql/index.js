...
module.exports = function (configuration) {
    ...
    var tableAccess = function (table) {
        ...
        if (table.dynamicSchema === undefined || table.dynamicSchema)
            return {
                read: function (query) {
                    return dynamicSchema(configuration).read(table, statements.read(query)).then(translateVersion);
                },
                ...
                delete: function (id, version) {
                    return execute(configuration, statements.delete(table, id, version)).then(returnSingleResult);
                },
                truncate: function () {
            ...
            return {
                read: function (query) {
                    return execute(configuration, statements.read(query)).then(translateVersion);
                },
                update: function (item) {
