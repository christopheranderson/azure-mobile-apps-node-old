...
CREATE LOGIN [azure-mobile-apps-test] WITH PASSWORD=N'YZwD2glU1+S1E1L9keqachY2BdGUd/rbIzM6Od27gi8=', DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english], CHECK_EXPIRATION=OFF, CHECK_POLICY=OFF
GO

ALTER LOGIN [azure-mobile-apps-test] DISABLE
GO
