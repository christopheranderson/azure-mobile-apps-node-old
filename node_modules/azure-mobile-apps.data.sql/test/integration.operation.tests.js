...
describe('azure-mobile-apps.data.sql.integration.operations', function () {
    ...
    beforeEach(function (done) {
        return index(config).truncate('integration').then(done);
    });
    ...
    function read() {
        return verbs.read(queries.create('integration'));
    }

    function insert(item) {
        return verbs.insert('integration', item);
    }

    function update(item) {
        return verbs.update('integration', item);
    }

    function del(id) {
        return verbs.delete('integration', id);
    }
});
