...
describe('azure-mobile-apps.data.sql.statements', function () {
    ...
    describe('createTable', function () {
        ...
        it('generates integer identity column when autoIncrement is specified', function () {
            ...
            expect(statement.sql).to.equal('CREATE TABLE [dbo].[table] ([id] INT NOT NULL IDENTITY (1, 1),[text] NVARCHAR(MAX) NULL) ON [PRIMARY]; ALTER TABLE [dbo].[table] ADD CONSTRAINT PK_table PRIMARY KEY CLUSTERED (id) ON [PRIMARY]')
        });
    });
});
