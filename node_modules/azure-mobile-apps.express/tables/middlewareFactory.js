...
module.exports = function (configuration, router) {
    configureOperation('get');
    configureOperation('post');
    configureOperation('patch');
    configureOperation('delete');
    ...
    tableMiddleware.unshift(attachProperty('_table', configuration), parseQuery);
    tableMiddleware.push(renderResults)

    return tableMiddleware;

    function configureOperation(verb) {
