...
module.exports = function (configuration, router, executeOperation) {
    ...
    configureOperation('get', [parseQuery(configuration)], [renderResults]);
    configureOperation('post', [parseItem(configuration)], [renderResults]);
    configureOperation('patch', [parseItem(configuration)], [renderResults]);
    configureOperation('delete', [parseQuery(configuration)], [renderResults]);
