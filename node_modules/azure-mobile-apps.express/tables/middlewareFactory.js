...
module.exports = function (configuration, router, executeOperation) {
    ...
    configureOperation('get', [parseQuery(configuration.table)], [renderResults]);
    configureOperation('post', [parseItem(configuration.table)], [renderResults]);
    configureOperation('patch', [parseItem(configuration.table)], [renderResults]);
    configureOperation('delete', [parseQuery(configuration.table)], [renderResults]);
    ...
    function configureOperation(verb, pre, post) {
        ...
        router[verb]('/' + configuration.table + '/:id', middleware);
        router[verb]('/' + configuration.table, middleware);
}
};
