var table = require('azure-mobile-apps.express/tables/table'),
    executeOperation = require('azure-mobile-apps.express/middleware/executeOperation'),
    expect = require('chai').expect,
    express = require('express');

describe('azure-mobile-apps.express.tables.configuration', function () {
    ...
    it('generates middleware stack for individual operations', function () {
        ...
        expect(stack[0].stack[0].route.stack.length).to.equal(5);
        expect(stack[0].stack[0].route.stack[2].handle).to.equal(testMiddleware);
        expect(stack[0].stack[0].route.stack[3].handle).to.equal(testMiddleware);
    });
