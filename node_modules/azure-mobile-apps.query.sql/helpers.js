...
var _ = require('underscore'),
    ...
    types = require('azure-mobile-apps.core/utilities/types'),
...
// to user log, etc.
var SqlApplicationErrorCodes = _.extend({
    LoginFailed: SqlErrorCodes.LoginFailed,
    GeneralError: SqlErrorCodes.GeneralError
}, SqlTemporaryErrorCodes);

module.exports = {
    SqlErrorCodes: SqlErrorCodes,
    SqlTemporaryErrorCodes: SqlTemporaryErrorCodes,
    SqlErrorNumbers: SqlErrorNumbers,
    SqlApplicationErrorCodes: SqlApplicationErrorCodes,
    ...
    getSqlType: function (value) {
        ...
        switch (type) {
            ...
            default:
                throw new Error(_.sprintf("Unable to map type '%s' to a SQL type.", type));
        }
    }
};
