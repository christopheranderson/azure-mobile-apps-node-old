...
var types = require('azure-mobile-apps.core/utilities/types'),
    ...
    parseOData = require('azure-mobile-apps.query/query/parseOData'),
    ExpressionVisitor = require('azure-mobile-apps.query/query/ExpressionVisitor'),
    convertTypes = require('./convertTypes'),
    booleanize = require('./booleanize'),
    helpers = require('../helpers'),
    expressions = require('azure-mobile-apps.query/query/expressions');
...
function ctor(schemaName, tableMetadata) {
