...
var instanceMembers = {
    ...
    _parseLogicalOr: function () {
        ...
        while (this.token.id == TokenId.Or) {
            ...
            left = new BinaryExpression(left, right, 'Or');
        }
        return left;
    },
    ...
    _parseLogicalAnd: function () {
        ...
        while (this.token.id == TokenId.And) {
            ...
            left = new BinaryExpression(left, right, 'And');
        }
        return left;
    },
    ...
    _parseComparison: function () {
        ...
        while (this.token.id == TokenId.Equal || this.token.id == TokenId.NotEqual || this.token.id == TokenId.GreaterThan ||
            ...
            switch (opId) {
                case TokenId.Equal:
                    left = new BinaryExpression(left, right, 'Equal');
                    break;
                case TokenId.NotEqual:
                    left = new BinaryExpression(left, right, 'NotEqual');
                    break;
                case TokenId.GreaterThan:
                    left = new BinaryExpression(left, right, 'GreaterThan');
                    break;
                case TokenId.GreaterThanEqual:
                    left = new BinaryExpression(left, right, 'GreaterThanOrEqual');
                    break;
                case TokenId.LessThan:
                    left = new BinaryExpression(left, right, 'LessThan');
                    break;
                case TokenId.LessThanEqual:
                    left = new BinaryExpression(left, right, 'LessThanOrEqual');
                    break;
            }
        }
        return left;
    ...
    _parseAdditive: function () {
        ...
        while (this.token.id == TokenId.Add || this.token.id == TokenId.Sub) {
            ...
            switch (opId) {
                case TokenId.Add:
                    left = new BinaryExpression(left, right, 'Add');
                    break;
                case TokenId.Sub:
                    left = new BinaryExpression(left, right, 'Subtract');
                    break;
            }
        }
        return left;
        ...
        while (this.token.id == TokenId.Multiply || this.token.id == TokenId.Divide ||
            ...
            switch (opId) {
                case TokenId.Multiply:
                    left = new BinaryExpression(left, right, 'Multiply');
                    break;
                case TokenId.Divide:
                    left = new BinaryExpression(left, right, 'Divide');
                    break;
                case TokenId.Modulo:
                    left = new BinaryExpression(left, right, 'Modulo');
                    break;
            }
        }
        return left;
    ...
    _parseUnary: function () {
        if (this.token.id == TokenId.Minus || this.token.id == TokenId.Not) {
            ...
            if (opId == TokenId.Minus) {
                expr = new UnaryExpression(expr, 'Negate');
            }
            else {
                expr = new UnaryExpression(expr, 'Not');
            }
            return expr;
        }
        return this._parsePrimary();
...
var QueryParser = module.exports = core.defineClass(ctor, instanceMembers, classMembers);
