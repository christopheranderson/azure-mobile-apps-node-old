...
var instanceMembers = {
    ...
    _formatFilter: function (query, defaultFilter) {
        ...
        if (query.id !== undefined) {
            ...
            if (filterExpr) {
                filterExpr = new BinaryExpression(filterExpr, idFilterExpr, 'And');
            }
            else {
        ...
        if (this.tableMetadata.supportsSoftDelete && !query.includeDeleted) {
            ...
            if (filterExpr) {
                filterExpr = new BinaryExpression(filterExpr, deletedFilter, 'And');
            }
            else {
    ...
    _formatMappedStringMember: function (instance, mappedMemberInfo, args) {
        ...
        if (functionName == 'substringof') {
            ...
            var concat = new BinaryExpression(args[0], args[1], 'Add');
            this.visit(concat);
        }
