...
module.exports.initialise = function(config) {
    ...
    if (configuration && configuration.origins) {
        originRegexes = buildOriginRegexes(configuration.origins);
    }
};

module.exports.getHeaders = function(origin, headers, method) {
    var responseHeaders = {};
    if (origin && module.exports.isAllowedOrigin(origin)) {
...
module.exports.isAllowedOrigin = function(origin) {
